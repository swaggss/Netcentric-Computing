...
first_variable = input('please enter the first value: >_ ')
second_variable = input('please enter the second value: >_ ')
...
socket.sendto(message, ('localhost', 2001))

# receive result from server
server_result, server_address = socket.recvfrom(1024*2)
